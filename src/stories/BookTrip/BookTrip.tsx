    ...
    <div className="">
      ...
      <div className="flex flex-col items-center justify-center py-[35px]">
        ...
        <div className="flex items-start justify-center gap-[35px]">
          {activeTab === 'form1' && (
            <div className="shadow-xl border flex flex-col  max-w-xxl items-start justify-center h-[400px] px-[50px]">
              ...
              <div className="flex items-center justify-around gap-[35px]">
                <div className="flex flex-col items-center bg-white">
                  <div>
                    <img src={diani} />
                    <div className="p-[5px] border-b-[1px] border-gray-300 text-center text-xs">
                      Diani (+1day)
                    </div>
                    <div className="text-center">
                      <button className="flex items-center justify-center mt-[10px] text-[#F3533D] rounded-[20px] border-[2px] px-[20px] border-[#F3533D] py-[5px]">
                        <p className="text-sm">Add</p>
                        <span className="px-[10px]">
                          <FontAwesomeIcon
                            icon={solid('add')}
                            size="sm"
                            className="text-[#F3533D] cursor-pointer text-left"
                          />
                        </span>
                      </button>
                    </div>
                  ...
                  {/* <button className='text-[#F3533D] rounded-[20px] border-[2px] px-[20px] border-[#F3533D]'>
                        <p className='text-sm'>Add</p>
                        <span className="px-[10px]">
                            <FontAwesomeIcon
                            icon={solid('add')}
              ...
              <div className="relative left-[500px] top-[20px]">
