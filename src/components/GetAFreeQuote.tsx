    ...
    <div>
        ...
        <div className='grid grid-cols-3'>
            <div className='col-span-2'>
                <div className='flex'>
                    <img src={Elephants} alt='elephant photo' className='w-[300px] h-[200px] object-cover shadow-md'/>
                    <div className='flex justify-end items-end px-[65px] py-[20px] h-[200px] bg-white shadow-md'>
                        <div className='grid gap-[35px]'>
                            <div>
                            <h2 className='text-lg text-gray-900 tracking-wide'>3 Days Maasai Mara Camping Safari</h2>
                            <div className='flex justify-start items-center'><p className='text-lg font-semibold'>$ 1,850 </p><p className='mx-[5px] text-sm text-gray-400'>/</p>
